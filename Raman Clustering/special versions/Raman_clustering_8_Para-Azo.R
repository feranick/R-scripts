...
image(interp(X,Y,H,xo=seq(min(X), max(X), length = length(unique(X))), yo=seq(min(Y), max(Y), length = length(unique(Y)))), asp = aspratio, main=Par[8])
...
Summary<-rbind(sortedMean,stdA,stdB,stdC,stdD,stdE,stdF,stdG,stdH,Vol.F)
...
errbar(c(1:numPhase),sortedMean[8,],sortedMean[8,]+stdH,sortedMean[8,]-stdH,cex.lab=1.5,pch=16,xlab="Phase",ylab=Par[8],col=c(1:numPhase+1),cex=2,cex.axis=1.5,xaxt = "n");   axis(1, at = 1:numPhase,cex.axis=1.5);lines(sortedMean[8,])#;   title("B (H)",cex.main=1.8)
...
plot(A,H,col=Sort.Phase+1,type="p",pch=Sort.Phase+15,xlab=Par[1],ylab=Par[8],xlim=c(min(A),max(A)),ylim=c(min(H),max(H)))
legend("bottomright", bg = "white", paste("Phase ", 1:numPhase), col=1:numPhase+1,pch = 1:numPhase%%10+15, cex = 1.5)
grid(NULL, lwd = 1,equilogs =FALSE)
...
plot(E,A,col=Sort.Phase+1,type="p",pch=Sort.Phase+15,xlab=Par[3],ylab=Par[5],xlim=c(min(C),max(C)),ylim=c(min(E),max(E)))
legend("bottomright", bg = "white", paste("Phase ", 1:numPhase), col=1:numPhase+1,pch = 1:numPhase%%10+15, cex = 1.5)
grid(NULL, lwd = 1,equilogs =FALSE)
...
plot(E,B,col=Sort.Phase+1,type="p",pch=Sort.Phase+15,xlab=Par[5],ylab=Par[2],xlim=c(min(E),max(E)),ylim=c(min(B),max(B)))
legend("bottomright", bg = "white", paste("Phase ", 1:numPhase), col=1:numPhase+1,pch = 1:numPhase%%10+15, cex = 1.5)
grid(NULL, lwd = 1,equilogs =FALSE)
...
plot(E,C,col=Sort.Phase+1,type="p",pch=Sort.Phase+15,xlab=Par[5],ylab=Par[3],xlim=c(min(E),max(E)),ylim=c(min(C),max(C)))
legend("bottomright", bg = "white", paste("Phase ", 1:numPhase), col=1:numPhase+1,pch = 1:numPhase%%10+15, cex = 1.5)
grid(NULL, lwd = 1,equilogs =FALSE)
...
plot(E,D,col=Sort.Phase+1,type="p",pch=Sort.Phase+15,xlab=Par[5],ylab=Par[4],xlim=c(min(E),max(E)),ylim=c(min(D),max(D)))
legend("bottomright", bg = "white", paste("Phase ", 1:numPhase), col=1:numPhase+1,pch = 1:numPhase%%10+15, cex = 1.5)
grid(NULL, lwd = 1,equilogs =FALSE)
...
plot(E,F,col=Sort.Phase+1,type="p",pch=Sort.Phase+15,xlab=Par[5],ylab=Par[6],xlim=c(min(E),max(E)),ylim=c(min(F),max(F)))
legend("bottomright", bg = "white", paste("Phase ", 1:numPhase), col=1:numPhase+1,pch = 1:numPhase%%10+15, cex = 1.5)
grid(NULL, lwd = 1,equilogs =FALSE)
...
plot(E,G,col=Sort.Phase+1,type="p",pch=Sort.Phase+15,xlab=Par[5],ylab=Par[7],xlim=c(min(E),max(E)),ylim=c(min(G),max(G)))
legend("bottomright", bg = "white", paste("Phase ", 1:numPhase), col=1:numPhase+1,pch = 1:numPhase%%10+15, cex = 1.5)
grid(NULL, lwd = 1,equilogs =FALSE)
...
plot(E,H,col=Sort.Phase+1,type="p",pch=Sort.Phase+15,xlab=Par[5],ylab=Par[8],xlim=c(min(E),max(E)),ylim=c(min(H),max(H)))
legend("bottomright", bg = "white", paste("Phase ", 1:numPhase), col=1:numPhase+1,pch = 1:numPhase%%10+15, cex = 1.5)
grid(NULL, lwd = 1,equilogs =FALSE)
